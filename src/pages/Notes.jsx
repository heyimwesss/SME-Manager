...
export default function Notes() {
  ...
  async function markDone(id) {
    await supabase.from("business_notes").update({ status: "Done" }).eq("id", id);
    fetchNotes();
  }
      ...
      <div className="page">
        ...
        {activeNotes.map((n) => (
          <div key={n.id} className="note-item">
            ...
            {n.due_date && <div className="due-date">Due: {new Date(n.due_date).toLocaleDateString()}</div>}
            ...
            <div className="note-actions">
              ...
              <button className="done-btn" onClick={() => markDone(n.id)}>
                Done
              </button>
            </div>
          </div>
        ...
        <h3 style={{ cursor: "pointer" }} onClick={() => setShowCompleted(!showCompleted)}>
